                ...
                <div class="col-md-12">
                    ...
                    @if ($consultantReview)
                        @if ($disabled == 'disabled')
                            {!! Form::textarea('feedback',  $consultantReview->feedback , ['class' => 'form-control textarea-disabled']) !!}
                        @else
                            {!! Form::textarea('feedback',  $consultantReview->feedback , ['class' => 'form-control textarea']) !!}
                        @endif
                    @else
                        @if ($disabled == 'disabled')
                        {!! Form::textarea('feedback',  null , ['class' => 'form-control textarea-disabled']) !!}
                        @else
                        {!! Form::textarea('feedback',  null , ['class' => 'form-control textarea']) !!}
                        @endif
                    @endif
